      ...
      <el-header>
        ...
        <el-row>
          ...
          <el-col id="personalInfoPanel" :xs="8" :sm="6" :md="4" :lg="3" :xl="2">
              <el-avatar size=large id="mainAvatar" src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"></el-avatar>
              <el-dropdown trigger="click"  id="headerUserName">
                <span class="el-dropdown-link">
                  <span class="need-to-be-ellipsis" style="color:#409eff">张开楠Kano2333</span><span class="need-to-be-ellipsis"><i class="el-icon-arrow-down el-icon--right"></i></span>
                </span>
...
#personalInfoPanel,#headerUserName{
  height: 60px;
}
